...
app.post("/people", (req, res) => {
  ...
  People.insert({ username: "jf", password: "123", email: "123@qq.com" }).then(
    function (u) {
      console.log(u); // print user, with a auto generate uuid
    }
  );

  res.send({ username: "jf", password: "123", email: "123@qq.com" });
});
